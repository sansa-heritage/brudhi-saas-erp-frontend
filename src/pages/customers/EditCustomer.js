    ...
    return (
      ...
      >
        <div className="text-center py-5">
          ...
          <h5 className="mt-3 text-muted">Loading customer data...</h5>
        </div>
      </Container>
    );
  }
          ...
          <Card.Header className="bg-white border-0 pt-3 px-4">
            <div className="d-flex gap-2 border-bottom pb-2">
              <Button
                ...
                className={`fw-semibold text-decoration-none px-3 py-2 rounded-3 ${activeTab === "customer" ? "bg-light" : ""}`}
                style={{
                  color:
                    activeTab === "customer" ? "rgb(30, 58, 111)" : "#6c757d",
                }}
              >
            ...
            <div className="d-flex justify-content-between gap-3">
              ...
              >
                {saving ? (
                  ...
                  <>
                    <FaSave className="me-2" /> Update Customer
                  </>
                )}
              </Button>
            </div>
